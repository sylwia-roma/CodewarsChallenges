...
// he wants to know how many years 'Y' this sum 'P' has to be kept in the bank in
...
//        double profitAfterTaxes = 0;
//        double grossProfit = 0;
//        double sumProfit = principal;
//        int year = 0;
//
//        for(int i=1; i<Integer.MAX_VALUE; i++) {
//            grossProfit = sumProfit * interest;
//
//            profitAfterTaxes= grossProfit-(grossProfit*tax);
//
//            sumProfit = sumProfit+profitAfterTaxes;

//
//            if(sumProfit>=desired){
//                break;
//            }
//            year=i+1;
//        }
